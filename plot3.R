...
### Purpose of this R Script - This program creates a line plot for Sub_metering_values against the measurement timestamps for Feb 1 and Feb 2. The plot is saved in a png file plot3.png.   
### Date: Sep 7, 2014 
