...
### Purpose of this R Script - This program creates a line plot for Global_active_power against the measurement timestamp for Feb 1 and Feb 2. The plot is saved in a png file plot2.png.   
### Date: Sep 7, 2014  
...
#plot Global_active_power agains formatted date time values
#Plot on a png device with 480 px by 480 px dimension
png("plot2.png", width=480, height=480, units="px")
plot(frmt_dt_tm, df$Global_active_power,type="l", ylab="Global Active Power(kilowatts)", xlab="")
dev.off()